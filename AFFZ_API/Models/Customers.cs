...
public partial class Customers
{
    ...
    public string? Role { get; set; }             // User role (Customer, Admin, etc.)
    
    public virtual Role? RoleNavigation { get; set; }

    // Navigation properties
    public virtual ICollection<EligibilityRequest> CustomerRequests { get; set; } = new List<EligibilityRequest>();
}
